...
import { Calendar, CheckSquare, Clock, Sparkles, Shield, BarChart3 } from 'lucide-react';
                ...
                <div className="login-card">
                    ...
                    {!showEmailForm ? (
                        <>
                            ...
                            <button className="btn btn-secondary" style={{ width: '100%' }} onClick={() => setShowEmailForm(true)}>
                                Continue with Email
                            </button>
                        </>
                    ) : (
                        <form onSubmit={handleEmailLogin}>
                            ...
                            <button type="button" className="btn btn-ghost" style={{ width: '100%', marginTop: '8px' }} onClick={() => setShowEmailForm(false)}>
